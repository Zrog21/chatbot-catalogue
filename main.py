...
def poser_question(question, session_id="default", mode="catalogue"):
    ...
    pertinents_catalogue = vector_db.search_main(search_question, query_en, n=n_chunks, reference=reference, specs=specs)
    ...
    system_catalogue = (
        ...
        "RÈGLE CRITIQUE: Réponds en te basant sur les EXTRAITS FOURNIS et sur l'HISTORIQUE DE CONVERSATION. "
        "L'historique te permet de comprendre le contexte (si l'utilisateur dit 'une autre', 'en bleu', "
        "'la version non FOD', il fait référence aux échanges précédents). "
        "Analyse les extraits du catalogue pour extraire caractéristiques, références, tableaux, dimensions. "
        ...
        "INTERDIT: demander des clarifications ou précisions. Réponds TOUJOURS avec ce que tu as dans les extraits. "
        "Si la question est vague, donne la MEILLEURE réponse possible avec les extraits disponibles. "
        "Si aucun extrait ne concerne la question: réponds AUCUN_RESULTAT. "
